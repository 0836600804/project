package BHX_Swings.bhx.swing.textfield;
...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/BHX_IMG/folderImages/images/icons/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/BHX_IMG/folderImages/images/icons/eye_hide.png")).getImage();
