package BHX_Swings.bhx.swing.tableToModel;
...
public class Action extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdEdit = new BHX_Swings.bhx.swing.Button();
        cmdDelete = new BHX_Swings.bhx.swing.Button();

        cmdEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BHX_Swings/bhx/icon/edit.png"))); // NOI18N

        cmdDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BHX_Swings/bhx/icon/delete.png"))); // NOI18N
    ...
    private BHX_Swings.bhx.swing.Button cmdDelete;
    private BHX_Swings.bhx.swing.Button cmdEdit;
