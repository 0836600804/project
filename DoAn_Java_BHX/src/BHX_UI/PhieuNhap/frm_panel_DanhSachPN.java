 ...
 * @author VanPhu
 */
public class frm_panel_DanhSachPN extends javax.swing.JPanel {

    /**
     * Creates new form frm_panel_DanhSachPN
     */
    public frm_panel_DanhSachPN(JFrame main) {
        initComponents();
        table.getColumnModel().getColumn(4).setCellRenderer(new TableActionCellRender());
        table.getColumnModel().getColumn(4).setCellEditor(new TableActionCellEditor(new TableActionEvent() {
            @Override
            public void onEdit(int row) {
                frm_PhieuNhap pn = new frm_PhieuNhap(main);
                pn.setID("id");
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID PHIẾU", "TỔNG TIỀN", "NGÀY LẬP", "GHI CHÚ", "HÀNH ĐỘNG"
            }
        ) {
