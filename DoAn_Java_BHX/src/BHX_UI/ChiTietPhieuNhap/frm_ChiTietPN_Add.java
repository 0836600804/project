 ...
 * @author VanPhu
 */
public class frm_ChiTietPN_Add extends javax.swing.JFrame {
     ...
     */
    public frm_ChiTietPN_Add(JFrame main, frm_panel_PhieuNhap pn) {
        this.main = main;
        this.pn = pn;
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        setTitle("Thêm mới chi tiết phiếu nhập hàng");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_ChiTietPN_Add.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_ChiTietPN_Add().setVisible(true);
            }
        });
    }
