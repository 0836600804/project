 ...
 * @author VanPhu
 */
public class frm_panel_NhanVien_DanhSachNV extends javax.swing.JPanel {

    /**
     * Creates new form frm_panel_NhanVien_DanhSachNV
     */
    public frm_panel_NhanVien_DanhSachNV() {
        initComponents();
        table.getColumnModel().getColumn(11).setCellRenderer(new TableActionCellRender());
        table.getColumnModel().getColumn(6).setCellRenderer(new ImageCellRender());
        table.getColumnModel().getColumn(11).setCellEditor(new TableActionCellEditor(new TableActionEvent() {
            @Override
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Nhân Viên", "Tên Nhân Viên", "Ngày Sinh", "Giới Tính", "Học Vấn", "Chức Vụ", "Hình Ảnh", "CCCD", "Ngày Vào Làm", "Hệ Số Lương", "Lương", "Hành Động"
            }
        ) {
